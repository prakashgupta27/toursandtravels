                        ...
                        <div className="flex max-md:flex-wrap max-md:flex-col-reverse gap-y-8">
                            <div className="sidebar lg:w-1/4 md:w-1/3 w-full md:pr-12">
                                <div className="filter-type pb-8 border-b border-line">
                                    ...
                                    <div className="list-type mt-2"><h1 className='font-bold text-base'>Indian Kurties</h1>
                                        {['Anarkali Kurties', 'Short Kurties', 'Long Kurties', 'Kurti with Palazzo'].map((item, index) => (
                                            <div
                                                key={index}
                                    ...
                                    <h1 className='font-bold text-base'>Sarees</h1>
                                    <div className="list-type mt-2">
                                        {['Kanjeevaram', 'Banarasi', 'Cotton Sarees', 'Georgette Sarees'].map((item, index) => (
                                            <div
                                                key={index}
                                                className={`item flex items-center justify-between cursor-pointer ${dataType === item ? 'active' : ''}`}
                                                onClick={() => handleType(item)}
